...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(arr){
    ...
    for (let i = 0; i < arr.length; ++i) {
      let str = `name: ${arr[i].animal_name}, scientific: ${arr[i].scientific_name}`;
      res.push(str);
    }
    return res;
  }
  ...
  */
  ...
  function lowPopulationAnimals(arr){
    return arr.filter(x => x.population < 5);
  }
  ...
  */
  ...
  function USApop(arr){
    return arr.reduce((total, x) => x.population + total, 0);
  }
